  ...
  return (
    <View style={styles.conteudo}>
       <View style={{ alignItems: 'center' }}>
         <Image style={{ height: 150, width: 150, alignItems: 'center', marginBottom: 18}} source={require('../assets/pngtree-mobile-phone-receives-short-message-png-image_1716327.jpg')}/>
      </View>
